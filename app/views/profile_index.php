        ...
        <form role="form" method="post" action="<?php echo URL ?>profile/update/<?php echo $data['user_id']; ?>" enctype="multipart/form-data">
            <div class="col-md-3">
                <div class="form-group">
                    <?php
                    var_dump(pathinfo($data['profile_thumb']));
                    echo isset($data['profile_thumb']) ? image_thumb($data['profile_thumb']) : ' <img data-src="holder.js/140x140" class="img-circle" alt="140x140"
